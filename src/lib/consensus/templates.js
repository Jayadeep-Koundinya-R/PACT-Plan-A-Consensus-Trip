export function generatePlainEnglishReason(option, breakdowns, totalMembers) {
...
export function generateDeadlockAdvice(primaryCause, budgetGapCount, dateConflictCount, dealbreakerHitCount) {
  switch (primaryCause) {
    case 'budget_gap':
      return {
