...
export const radius = {
  sm: 8, md: 12, card: 18, cardLarge: 20, phone: 40, btn: 12, pill: 20
} as const;

export const shadows = {
  sm: { shadowColor: '#000000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 3, elevation: 1 },
  md: { shadowColor: '#000000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 10, elevation: 2 },
  lg: { shadowColor: '#000000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.35, shadowRadius: 16, elevation: 4 },
  glowPrimary: { shadowColor: '#FF5A5F', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.35, shadowRadius: 10, elevation: 3 },
  glowSuccess: { shadowColor: '#3DE0A0', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.35, shadowRadius: 12, elevation: 3 }
} as const;

/** Single theme ID — PACT ships with Obsidian Midnight only. */
export type ThemeId = 'obsidian_dark';
...
export function getThemeById(_themeId?: string): PactThemeDefinition {
  return pactThemes.obsidian_dark;
}
